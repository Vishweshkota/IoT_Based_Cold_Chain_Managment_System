...
/**
 * This class is a simple data container that simply needs to implement the getter and setter methods for system performance data.
 * It is derived from BaseIotData
 * 
 * It shas the fillowing attributes
 * - name
 * - typeID
 * - status code
 * - time stamp
